  ...
  return (
    <div className="detail-jawaban-peserta-pg card card-ss bg-white rounded-ss">
      ...
      <div className="card-body p-4">
        ...
        {/* Judul Soal Menjodohkan Start */}

        <h4 className="fw-bold color-dark mb-0">
          Jodohkan pertanyaan dengan jawaban yang tepat.
        </h4>

        {/* Judul Soal Menjodohkan End */}

        {/* List Soal Menjodohkan Start */}
        ...
        <div className="rounded-ss border border-light-secondary p-3 mb-4">
          ...
          <div className="mb-4">
            <p className="m-0">
              ...
              maiores natus, officiis, fugiat, officia asperiores ratione
              adipisci aliquam delectus exercitationem assumenda accusamus
              molestiae. Voluptatum quos animi deserunt quisquam! Modi, a?
            </p>
          </div>
          {/* Konten Soal End */}
          ...
          <div className="mb-4">
            ...
            <div className="list-jawaban-soal rounded-ss bg-soft-danger border border-danger-ss px-4 py-3 d-flex align-items-center mb-3">
        ...
        <div className="rounded-ss border border-light-secondary p-3 mb-4">
          ...
          {/* Jawaban Benar  Start */}
          {/* <div className="mb-4">
            <h6 className="fs-18-ss fw-bold color-dark me-4 mb-4">Jawaban Benar</h6>
            <div className="list-jawaban-soal rounded-ss bg-soft-danger border border-danger-ss px-4 py-3 d-flex align-items-center mb-3">
              <h6 className="fs-18-ss fw-bold color-dark mb-0 me-4">C</h6>
              <div className="konten-list-jawaban-soal">
                <p className="mb-0">Jawaban C</p>
...
export default HasilJawabanMenjodohkan;
