...
const HeaderAnalisisSoal = ({ children, ssURL, id, materi }) => {
  ...
  const navMenus = [
    {
      ...
      as: `${ssURL}/analisis-soal-ujian/${id}/data-soal`,
      text: "Data Soal",
      active: `${ssURL}/analisis-soal-ujian/[id]/data-soal`,
    },
    {
      href: `${ssURL}/analisis-soal-ujian/[id]/template-kesukaran`,
      as: `${ssURL}/analisis-soal-ujian/${id}/template-kesukaran`,
      text: "Template Kesukaran",
      active: `${ssURL}/analisis-soal-ujian/[id]/template-kesukaran`,
    },
  ];
      ...
      <div className="col-md-12">
        <div className="card-header-kelas-ss card card-kelas-ss card-ss px-0 mb-4">
          <div
            ...
            style={{
              minHeight: "150px",
              background: `url("/img/bg-header-analisis-soal-ujian.png")`,
          ...
          >
            ...
            >
              <img src="/img/icon-analisis-soal-ujian.svg" alt="" />
            </div>
            <div className="ms-md-4 ms-0 mt-md-0 mt-4">
              ...
              <p className="fs-6 fw-bold mb-0">Kelas {materi?.tingkat}</p>
            </div>
          </div>
          <div
...
export default HeaderAnalisisSoal;
