...
const HeaderKontenPerangkatPembelajaran = ({
  tingkatRombel,
  listRombel,
  title,
}) => {
                ...
                <div className="row justify-content-between align-items-center">
                  <div className="col-md-7">
                    <div className="d-flex justify-content-between mb-md-0 mb-2">
                      ...
                      <Link
                        href={`${ssURL}/perangkat-pembelajaran/[id]`}
                        as={`${ssURL}/perangkat-pembelajaran/1`}
                      >
...
export default HeaderKontenPerangkatPembelajaran;
