...
import HeaderDetailAlumni from "components/Shared/Header/HeaderDetailAlumni";

const LayoutDetailAlumni = ({
  children,
  listAngkatan,
  listJurusan,
  listStatus,
  ...
  return (
    <div className="smartschool-app">
      ...
      <HeaderDetailAlumni
        ...
        selectAngkatan={selectAngkatan}
        selectJurusan={selectJurusan}
        selectStatus={selectStatus}
        urlAngkatan={urlAngkatan}
        urlJurusan={urlJurusan}
        urlStatus={urlStatus}
      />
...
export default LayoutDetailAlumni;
