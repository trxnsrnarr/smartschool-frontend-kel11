...
import HeaderPendaftarPPDB from "components/Shared/Header/HeaderPendaftarPPDB";

const LayoutPendaftarPPDB = ({
  children,
  isFluid,
  title,
  modalWrapper,
...
export default LayoutPendaftarPPDB;
