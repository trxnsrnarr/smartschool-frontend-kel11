...
const HeaderInventaris = ({ children, ssURL, id, judul }) => {
  ...
  const navMenus = [
    {
      href: `${ssURL}/inventaris/aset-tertunda`,
      as: `${ssURL}/inventaris/aset-tertunda`,
      text: "Aset Tertunda",
      active: `${ssURL}/inventaris/aset-tertunda`,
    },
    {
      href: `${ssURL}/inventaris/aset-aktif`,
      as: `${ssURL}/inventaris/aset-aktif`,
      text: "Aset Aktif",
      active: `${ssURL}/inventaris/aset-aktif`,
    },
    {
      href: `${ssURL}/inventaris/penyusutan`,
      as: `${ssURL}/inventaris/penyusutan`,
      text: "Penyusutan",
      active: `${ssURL}/inventaris/penyusutan`,
    },
  ];
      ...
      <div className="col-md-12">
        <div className="card-header-kelas-ss card card-kelas-ss card-ss px-0 mb-4">
          <div
            ...
            style={{
              minHeight: "150px",
              background: `url("/img/bg-header-inventaris.png")`,
          ...
          >
            ...
            >
               <img src="/img/icon-inventaris.svg" alt="" />
            </div>
...
export default HeaderInventaris;
