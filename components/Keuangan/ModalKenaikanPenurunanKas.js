...
const ModalKenaikanPenurunanKas = ({
  setCurrentRumus,
  currentRumus,
  arus,
  formData,
  ...
  return (
    <NewModal
      modalSize="md"
      modalId="modalKenaikanPenurunanKas"
      title={
        <>
          <h4 className="mb-1 fw-extrabold">
            {/* {formData?.idKategori ? "Edit" : "Buat"} */}
            Rumus Kenaikan (Penurunan) Kas
          </h4>
        </>
      }
      content={
...
export default ModalKenaikanPenurunanKas;
