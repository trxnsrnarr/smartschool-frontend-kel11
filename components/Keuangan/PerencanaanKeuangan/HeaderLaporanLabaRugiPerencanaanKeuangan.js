...
const HeaderLaporanLabaRugiPerencanaanKeuangan = ({
  children,
  ssURL,
  id,
  rencana,
    ...
    navMenus = [
      {
        ...
        text: "Data Laporan",
        active: `${ssURL}/perencanaan-keuangan/[id]/laporan-laba-rugi/data-laporan`,
      },
      {
        href: `${ssURL}/perencanaan-keuangan/[id]/laporan-laba-rugi/template-laporan`,
        as: `${ssURL}/perencanaan-keuangan/${id}/laporan-laba-rugi/template-laporan`,
        text: "Template Laporan",
        active: `${ssURL}/perencanaan-keuangan/[id]/laporan-laba-rugi/template-laporan`,
      },
    ];
  } else {
    navMenus = [
...
export default HeaderLaporanLabaRugiPerencanaanKeuangan;
