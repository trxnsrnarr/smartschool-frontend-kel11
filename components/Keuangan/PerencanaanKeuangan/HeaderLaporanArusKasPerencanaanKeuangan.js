...
const HeaderLaporanArusKasPerencanaanKeuangan = ({
  children,
  ssURL,
  id,
  rencana,
    ...
    navMenus = [
      {
        ...
        text: "Data Laporan",
        active: `${ssURL}/perencanaan-keuangan/[id]/laporan-arus-kas/data-laporan`,
      },
      {
        href: `${ssURL}/perencanaan-keuangan/[id]/laporan-arus-kas/template-laporan`,
        as: `${ssURL}/perencanaan-keuangan/${id}/laporan-arus-kas/template-laporan`,
        text: "Template Laporan",
        active: `${ssURL}/perencanaan-keuangan/[id]/laporan-arus-kas/template-laporan`,
      },
      {
        href: `${ssURL}/perencanaan-keuangan/[id]/laporan-arus-kas/tipe-akun`,
        as: `${ssURL}/perencanaan-keuangan/${id}/laporan-arus-kas/tipe-akun`,
        text: "Tipe Akun",
        active: `${ssURL}/perencanaan-keuangan/[id]/laporan-arus-kas/tipe-akun`,
      },
    ];
  } else {
    navMenus = [
...
export default HeaderLaporanArusKasPerencanaanKeuangan;
