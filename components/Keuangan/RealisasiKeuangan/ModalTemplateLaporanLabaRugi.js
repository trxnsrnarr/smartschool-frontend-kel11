...
const ModalTemplateLaporanLabaRugi = ({
  edit,
  ...
  return (
    <>
      <NewModal
        modalId="modalTemplateLaporanLabaRugi"
        modalSize="lg"
        title={
          <>
            <h4 className="mb-1 fw-extrabold">
              {ditambah ? "Tambah" : "Edit"} Akun
            </h4>
        ...
        submitButton={
          <ReactiveButton
            ...
            onClick={ditambah ? _postAkunLaba : _editAKunLaba}
            color={"primary"}
            idleText={"Simpan"}
...
export default ModalTemplateLaporanLabaRugi;
