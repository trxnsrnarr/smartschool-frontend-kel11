  ...
  return (
    <>
      <NewModal
        ...
        title={
          <>
            <h4 className="mb-1 fw-extrabold">Buat Capaian Pembelajaran</h4>
            <span className="fs-6 fw-normal">
              Isi informasi dibawah untuk membuat Capaian Pembelajaran
            </span>
          </>
        }
        content={
          <>
            <div className="mb-4">
              <label className="form-label">Judul Capaian Pembelajaran</label>
              <input
