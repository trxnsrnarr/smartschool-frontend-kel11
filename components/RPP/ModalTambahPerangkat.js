  ...
  return (
    <>
      <NewModal
        ...
        title={
          <>
            <h4 className="mb-1 fw-extrabold">Buat Perangkat</h4>
            <span className="fs-6 fw-normal">
              Isi informasi dibawah untuk membuat Perangkat
            </span>
          </>
        }
        content={
          <>
            ...
            <div className="mb-4">
              ...
              <TextareaAutosize
                ...
                placeholder="Tuliskan deskripsi Perangkat"
                minRows={3}
                name="deskripsi"
        ...
        submitButton={
          <ReactiveButton
            ...
            onClick={() => (isEdit ? _editPerangkat() : _postPerangkat())}
          />
        }
      />
    </>
...
export default ModalTambahPerangkat;
