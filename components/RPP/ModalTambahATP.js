  ...
  return (
    <>
      <NewModal
        ...
        title={
          <>
            <h4 className="mb-1 fw-extrabold">Buat ATP</h4>
            <span className="fs-6 fw-normal">
              Isi informasi dibawah untuk membuat ATP
            </span>
          </>
        }
        content={
          <>
            <div className="mb-4">
              <label className="form-label">Judul ATP</label>
              <input
            ...
            <div className="mb-4">
              ...
              <TextareaAutosize
                ...
                placeholder="Tuliskan deskripsi ATP"
                minRows={3}
                name="deskripsi"
