...
import { postPerusahaan, editPerusahaan } from "client/PerusahaanClient";
...
const ModalTambahPerusahaan = ({
  ...
  const _postPerusahaan = async () => {
    ...
    const { data, error } = await postPerusahaan({
      ...formData,
      // tkPerusahaanSekolahId: formData?.id,
  ...
  const _putPerusahaan = async () => {
    ...
    const { data, error } = await editPerusahaan(formData?.mPerusahaanId, {
      ...formData,
      // tkPerusahaanSekolahId: formData?.id,
      keselarasan: formData?.keselarasan == true ? 1 : 0,
      istd: formData?.istd == true ? 1 : 0,
    ...
    if (editData) {
      _getProvince(),
        ...
        setFormData({
          ...
          registrasi_pj: momentPackage(
            editData?.informasi?.registrasiPj
  ...
  return (
    <>
      <NewModal
        ...
        modalId="modalTambahPerusahaan"
        modalSize="fullscreen"
        title={
          <>
            <h4 className="mb-1 fw-extrabold">
              {editData ? `Ubah` : `Tambah`} Perusahaan
            </h4>
                  ...
                  <div className="card card-ss p-4 pb-5">
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-md-6">
                        <UploadPhoto
                          name="sampul"
                          id="uploadPhotoSampulPerusahaan"
                          label="Foto Sampul Perusahaan"
                          titleUnggahan="Foto"
                          col="col-md-12"
                          max={1}
                          listPhoto={
                            typeof formData?.sampul == "string" &&
                            formData?.sampul
                              ? [formData?.sampul]
                              : formData?.sampul
                          }
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-md-6">
                        ...
                        <DatePicker
                          ...
                          placeholder="Pilih Tanggal Registrasiss"
                          className="form-control"
                          autoComplete="off"
                          value={
        ...
        submitButton={
          <ReactiveButton
            ...
            onClick={editData ? _putPerusahaan : _postPerusahaan}
          />
        }
      />
    </>
...
export default ModalTambahPerusahaan;
