...
const ModalPenerimaanPkl = ({ editData, _getPenerimaanPerusahaan, id }) => {
  ...
  return (
    <>
      <NewModal
        modalId="modalPenerimaanPkl"
        modalSize="md"
        title={
          <>
            <h4 className="mb-1 fw-extrabold">
              {editData ? "Ubah" : "Tambah"} Penerimaan
            </h4>
        ...
        content={
          <>
            <div className="mb-4">
              <label className="form-label">Nama Penerimaan</label>
              <input
                className="form-control"
                autoComplete="off"
                type="text"
                name="nama"
                placeholder="Contoh: Penerimaan PKL Tahun Ajaran 2021/2022"
                value={formData?.nama}
        ...
        submitButton={
          <ReactiveButton
            ...
            onClick={
              editData ? _putPenerimaanPerusahaan : _postPenerimaanPerusahaan
            }
            color={"primary"}
...
export default ModalPenerimaanPkl;
