...
const HeaderDaftarNilai = ({
  ...
  const navMenus = [
    {
      href: `${ssURL}/buku-kerja-guru/daftar-nilai/${id}?nav=tugas`,
      as: `${ssURL}/buku-kerja-guru/daftar-nilai/${id}?nav=tugas`,
      text: "Tugas",
      active: nav == "tugas" || nav == undefined,
      onClick: setTipeTugas(),
    },
    {
      href: `${ssURL}/buku-kerja-guru/daftar-nilai/${id}?nav=ujian`,
      as: `${ssURL}/buku-kerja-guru/daftar-nilai/${id}?nav=ujian`,
      text: "Ujian Harian",
      active: nav == "ujian",
      onClick: setTipeUjian(),
    },
  ];
...
export default HeaderDaftarNilai;
