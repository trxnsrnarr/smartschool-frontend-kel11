...
const SectionTandaTanganRaporYadikaPrint = ({
  isReadOnly = false,
  walikelas,
  ta,
  sekolah,
  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-start px-4 mb-4">
        ...
        <div className="">
          <h6 className="fs-12-ss mb-2" style={{ opacity: "0" }}>
            Mengetahui
          </h6>
          <h6 className="fs-12-ss" style={{ marginBottom: "85px" }}>
            Wali Kelas
      ...
      <div className="d-flex justify-content-center align-items-center px-4"></div>
    </>
  );
};

export default SectionTandaTanganRaporYadikaPrint;
