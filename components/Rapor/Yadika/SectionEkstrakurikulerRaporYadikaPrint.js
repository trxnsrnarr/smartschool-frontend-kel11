const SectionEkstrakurikulerRaporYadikaPrint = ({
  isReadOnly = false,
  ekskul,
}) => {
  return (
    <>
      <h6 className="fs-14-ss fw-bold mb-2">D. Ekstrakurikuler</h6>
...
export default SectionEkstrakurikulerRaporYadikaPrint;
