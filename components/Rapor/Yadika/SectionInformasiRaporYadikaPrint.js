const SectionInformasiRaporYadikaPrint = ({
  isBukuInduk,
  sekolah,
  siswa,
  ta,
      ...
      <div>
        <div className="row text-center mb-3">
          <div className="col-md-12">
            <h5 className="fs-14-ss fw-bold text-uppercase mb-0">
              HASIL PENCAPAIAN KOMPETENSI PESERTA DIDIK
            </h5>
          </div>
        </div>
        <div className="" style={{ borderColor: "#000000" }}>
          <div className="row">
            <div className="col-7">
...
export default SectionInformasiRaporYadikaPrint;
