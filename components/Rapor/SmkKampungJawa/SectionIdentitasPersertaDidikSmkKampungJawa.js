...
import { postProfilUser, postProfilUserAdmin } from "client/AuthClient";
import {
  getDistrict,
  getProvince,
  getRegency,
...
const SectionIndetitasPesertaDidikSmkKampungJawa = ({
  isReadOnly = false,
  siswa,
  sekolah,
  ta,
...
export default SectionIndetitasPesertaDidikSmkKampungJawa;
