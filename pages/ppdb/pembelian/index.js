...
const DashboardPPDBPage = () => {
  ...
  const { gelombang, gelombangAktif, gelombangPembelian } = gelombangPPDB;
  ...
  const _postPendaftarPPDB = async (d) => {
    ...
    if (data) {
      ...
      router.push(`${ppdbURL}/bayar-formulir`);
    } else {
            ...
            <>
              <div className="card card-ss mb-4">
                <div className="card-body p-4 pb-5">
                  ...
                  <div
                    onClick={() => router.push(`${ppdbURL}/bayar-formulir`)}
                  ...
                  >
                    ...
                    <div className="ms-4">
                      ...
                      <h6 className="fw-bold color-secondary mb-0">
                        {`${momentPackage(
                          gelombangPembelian?.gelombang?.dibuka
                        ).format("DD MMMM YYYY HH:mm")} - ${momentPackage(
                          gelombangPembelian?.gelombang?.ditutup
              ...
              <div className="card card-ss">
                <div className="card-body p-4 text-center">
                  ...
                  <button
                    ...
                    onClick={() => _delete(gelombangPembelian?.id)}
                  >
            ...
            <div className="card card-ss">
              <div className="card-header-ss p-4">
                ...
                <p className="mb-0 color-dark">
                  Pilih gelombang dibawah ini untuk melakukan pendaftaran PPDB.
                </p>
              </div>
