...
import ModalTambahTugas from "../../../../../../components/Rekap/ModalTambahTugas";
...
const index = ({ id, materi_id }) => {
  ...
  const rombelKelas = materirombel
    ...
    ?.map((data, idx) => {
      ...
      return {
        id: `${data?.rombel?.id}`,
        // url: `${ssURL}/rekap/${id}/materi/${materi_id}?rombel_id=${data?.rombel?.id}`,
        kelas: `${kelas}`,
        tingkat: `${tingkat}`,
    ...
    <Layout>
      <AnimatePage>
        ...
        <ModalTambahTugas
          ...
          formData={formData}
          _postRekapTugas={_postRekapTugas}
          tugas={tugas}
        />
      </AnimatePage>
    </Layout>
