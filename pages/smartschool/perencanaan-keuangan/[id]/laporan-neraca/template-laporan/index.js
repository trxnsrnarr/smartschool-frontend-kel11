...
const index = ({ subnav, id }) => {
  ...
  const _postKategori = async () => {
    ...
    const { data } = await postKategoriNeraca(id, {
      ...formData,
  ...
  const _editAkunNeraca = async (idUrutan, mKeuAkunIdUrutan, urutan) => {
    ...
    setFormData({ ...formData, btnBio: "loading" });
    const { data, error } = await putAkunNeraca(id, {
      ...formData,
      mKeuAkunId,
      urutan,
    });
  ...
  const navItems = [
    {
      url: `${ssURL}/perencanaan-keuangan/${id}/laporan-neraca/template-laporan?subnav=aktiva`,
      as: `${ssURL}/perencanaan-keuangan/${id}/laporan-neraca/template-laporan?subnav=aktiva`,
      text: "Aktiva",
      active: subnav == "aktiva" || !subnav,
      dataJoyride: "saat-ini",
    },
    {
      url: `${ssURL}/perencanaan-keuangan/${id}/laporan-neraca/template-laporan?subnav=pasiva`,
      as: `${ssURL}/perencanaan-keuangan/${id}/laporan-neraca/template-laporan?subnav=pasiva`,
      text: "Pasiva",
  ...
  return (
    ...
    >
      <AnimatePage>
        <HeaderLaporanNeracaPerencanaanKeuangan ssURL={ssURL} id={id} />
        <Navbar
          nav={navItems}
          action={[
            {
