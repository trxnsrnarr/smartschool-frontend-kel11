...
const index = ({ user_id }) => {
  ...
  const tableData = [
    {
      id: "daftar evaluasi diri kerja guru",
      instrumen: "Daftar Evaluasi Diri Kerja Guru",
      files: daftarEvaluasi
    },
    {
      id: "program tindak lanjut kerja guru",
      instrumen: "Program Tindak Lanjut Kerja Guru",
      files: tindakLanjut
    },
  ];
              ...
              <div className="card-header p-4 card-header-ss">
                <div className="row">
                  <div className="col-md-8 col-12 d-flex align-items-center">
                    ...
                    <span className={`${total == 2 ? "label-light-success-ss" : "label-light-danger-ss"} label-ss fs-12-ss fw-semibold rounded-pill ms-4`}>
                      {`${total}/2 Instrumen`}
                    </span>
                  </div>
