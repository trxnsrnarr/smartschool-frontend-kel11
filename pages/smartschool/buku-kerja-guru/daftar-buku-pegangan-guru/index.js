...
const index = (props) => {
  ...
  const onClickEdit = (editData) => {
    showModal("modalTambahBukuPeganganGuru");
    setEditModal("modalTambahBukuPeganganGuru", editData);
  }
      ...
      <div className="row mt-4 pt-4 g-4">
        { datas?.map(data =>
          <CardBukuKerja
            ...
            bottomLabel={[ { icon: "/img/icon-skl-ki-kd.svg", text: `Kelas ${data?.rombel?.tingkat}` } ]}
